...
#ifndef FLATBUFFERS_GENERATED_RENDERDATA_GAMEPLAY_H_
#define FLATBUFFERS_GENERATED_RENDERDATA_GAMEPLAY_H_
...
struct GPRenderCharacterData FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const gameplay::GPTrans2D *transform() const {
    return GetStruct<const gameplay::GPTrans2D *>(VT_TRANSFORM);
  }
  const gameplay::GPMotionState *motion_state() const {
    return GetStruct<const gameplay::GPMotionState *>(VT_MOTION_STATE);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_ID, 4) &&
           VerifyField<gameplay::GPTrans2D>(verifier, VT_TRANSFORM, 4) &&
           VerifyField<gameplay::GPMotionState>(verifier, VT_MOTION_STATE, 4) &&
           verifier.EndTable();
  }
};
...
struct GPRenderCharacterDataBuilder {
  ...
  void add_transform(const gameplay::GPTrans2D *transform) {
    fbb_.AddStruct(GPRenderCharacterData::VT_TRANSFORM, transform);
  }
  void add_motion_state(const gameplay::GPMotionState *motion_state) {
...
inline ::flatbuffers::Offset<GPRenderCharacterData> CreateGPRenderCharacterData(
    ...
    int32_t id = 0,
    const gameplay::GPTrans2D *transform = nullptr,
    const gameplay::GPMotionState *motion_state = nullptr) {
...
struct GPRenderData FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const gameplay::GPRenderCharacterData *character0() const {
    return GetPointer<const gameplay::GPRenderCharacterData *>(VT_CHARACTER0);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<gameplay::GPRenderCharacterData>> *monsters() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<gameplay::GPRenderCharacterData>> *>(VT_MONSTERS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct GPRenderDataBuilder {
  ...
  void add_character0(::flatbuffers::Offset<gameplay::GPRenderCharacterData> character0) {
    fbb_.AddOffset(GPRenderData::VT_CHARACTER0, character0);
  }
  void add_monsters(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<gameplay::GPRenderCharacterData>>> monsters) {
...
inline ::flatbuffers::Offset<GPRenderData> CreateGPRenderData(
    ...
    ::flatbuffers::Offset<gameplay::GPRenderCharacterData> character0 = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<gameplay::GPRenderCharacterData>>> monsters = 0) {
...
inline ::flatbuffers::Offset<GPRenderData> CreateGPRenderDataDirect(
    ...
    int32_t generation = 0,
    ::flatbuffers::Offset<gameplay::GPRenderCharacterData> character0 = 0,
    const std::vector<::flatbuffers::Offset<gameplay::GPRenderCharacterData>> *monsters = nullptr) {
  auto monsters__ = monsters ? _fbb.CreateVector<::flatbuffers::Offset<gameplay::GPRenderCharacterData>>(*monsters) : 0;
  return gameplay::CreateGPRenderData(
      _fbb,
      generation,
      character0,
      monsters__);
...
inline const gameplay::GPRenderData *GetGPRenderData(const void *buf) {
  return ::flatbuffers::GetRoot<gameplay::GPRenderData>(buf);
}

inline const gameplay::GPRenderData *GetSizePrefixedGPRenderData(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<gameplay::GPRenderData>(buf);
}

inline bool VerifyGPRenderDataBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<gameplay::GPRenderData>(nullptr);
}

inline bool VerifySizePrefixedGPRenderDataBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<gameplay::GPRenderData>(nullptr);
}

inline void FinishGPRenderDataBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<gameplay::GPRenderData> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_RENDERDATA_GAMEPLAY_H_
